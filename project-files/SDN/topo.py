...
class final_topo(Topo):
  def build(self):
    ...
    self.addLink(switch1, coreswitch, port1=11, port2=11)
    ...
    self.addLink(laptop1, switch4, port1=1, port2=5)
    self.addLink(printer, switch4, port1=1, port2=6)
    ...
    self.addLink(workstation1, switch1, port1=1, port2=2)
    self.addLink(workstation2, switch1, port1=1, port2=3)
    ...
    self.addLink(workstation3, switch2, port1=1, port2=3)
    self.addLink(workstation4, switch2, port1=1, port2=4)
    ...
    self.addLink(Server2, switch3, port1=1, port2=4)
    self.addLink(WebServer, switch3, port1=1, port2=5)
    self.addLink(DNSServer, switch3, port1=1, port2=6)
